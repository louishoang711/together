...
export const eventConfig = {
  brand: {
    ...
    logo: '/event-assets/logo.png',
    scratchLogo: '/event-assets/logo.png',
    eventName: 'CÔNG VIÊN THÚ CƯNG ANH ĐÀO',
    year: '2026',
  ...
  copy: {
    ...
    loginDescription: 'Nhập số điện thoại để mở hộ chiếu sự kiện của bạn.',
    nameLabel: 'Họ và tên :',
